...
namespace Popoviciu_Andreea_Lab2.Data
{
    public class Popoviciu_Andreea_Lab2Context : DbContext
    {
        ...
        public DbSet<Popoviciu_Andreea_Lab2.Models.Category> Category { get; set; }

        public DbSet<Popoviciu_Andreea_Lab2.Models.Member> Member { get; set; }

        public DbSet<Popoviciu_Andreea_Lab2.Models.Borrowing> Borrowing { get; set; }
    }
}
